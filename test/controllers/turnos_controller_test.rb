...
class TurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post turnos_url, params: { turno: { descripcion: @turno.descripcion, destino: @turno.destino, direccion_salida: @turno.direccion_salida, fecha_salida: @turno.fecha_salida, hora_salida: @turno.hora_salida, numero_personas: @turno.numero_personas, numero_turno: @turno.numero_turno, tipo: @turno.tipo, vacantes_libres: @turno.vacantes_libres } }
    end
  ...
  test "should update turno" do
    patch turno_url(@turno), params: { turno: { descripcion: @turno.descripcion, destino: @turno.destino, direccion_salida: @turno.direccion_salida, fecha_salida: @turno.fecha_salida, hora_salida: @turno.hora_salida, numero_personas: @turno.numero_personas, numero_turno: @turno.numero_turno, tipo: @turno.tipo, vacantes_libres: @turno.vacantes_libres } }
